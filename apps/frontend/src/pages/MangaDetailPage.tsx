  ...
  return (
    <div className="bg-cream min-h-screen pt-24 pb-12">
      ...
      <div className="relative h-64 lg:h-80 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-t from-cream via-cream/80 to-transparent" />
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 -mt-32 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Poster */}
          <div className="lg:col-span-1">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white/50 rounded-2xl p-6">
              <h2 className="text-xl font-bold text-dark mb-4">Information</h2>
